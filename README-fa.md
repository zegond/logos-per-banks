...
نسخه ۱.۰۱  [لیست تغییرات](https://github.com/zegond/logos-per-banks/blob/master/CHANGELOG.md)
...
- [Adobe XD](https://github.com/zegond/logos-per-banks/blob/master/README-fa.md#adobe-xd)
...
با استفاده از [این لینک](https://sketch.cloud/s/pxQQQ) می‌توانید نسخه اسکچ را به صورت لایبرری به اسکچ اضافه کنید و نسخه جدید را به طور مستقیم درون خود اسکچ دریافت کنید. به همین راحتی
...
با استفاده از [ین لینک](https://www.figma.com/file/siz6HblbLsZTnBbF98lczO) می‌توانید آخرین نسخه فایل فیگما را مشاهده کنید. پس از باز کردن، روی فلش کنار نام فایل زده و "داپلیکیت" را انتخاب کنید. این کار یک کپی از فایل را به درفت‌های شما اضافه خواهد کرد تا بتوانید بدون محدودیت از آن استفاده کنید
